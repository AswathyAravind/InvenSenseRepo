 ...
 * statement.
 */
public final class ForecastHPreparedStatementSetter implements ItemPreparedStatementSetter<ForecastHistoryC> {
	private static final Logger LOGGER = LoggerFactory.getLogger(ForecastHPreparedStatementSetter.class);

	@Override
	public void setValues(ForecastHistoryC forecastHistoryC, PreparedStatement preparedStatement) throws SQLException {
		try {
			...
			if (forecastHistoryC.getForecastIdC() != null && forecastHistoryC.getForecastIdC().getValue() != null) {
				preparedStatement.setString(20, forecastHistoryC.getCurcyConvRateType().getValue());
			} else {
				preparedStatement.setString(20, null);
			}

			if (forecastHistoryC.getForecastC() != null) {
				preparedStatement.setString(21, forecastHistoryC.getForecastC().getValue());
			} else {
				preparedStatement.setString(21, null);
			}

			if (forecastHistoryC.getLockedMonthC() != null) {
				preparedStatement.setString(22, forecastHistoryC.getLockedMonthC().getValue());
			} else {
				preparedStatement.setString(22, null);
			}

			if (forecastHistoryC.getLockedYearC() != null) {
				preparedStatement.setString(23, forecastHistoryC.getLockedYearC().getValue());
			} else {
				preparedStatement.setString(23, null);
			}

			if (forecastHistoryC.getLockedByIDC() != null) {
				preparedStatement.setString(24, forecastHistoryC.getLockedByIDC().getValue());
			} else {
				preparedStatement.setString(24, null);
			}

			if (forecastHistoryC.getLockedByUserNameC() != null) {
				preparedStatement.setString(25, forecastHistoryC.getLockedByUserNameC().getValue());
			} else {
			...
			if (forecastHistoryC.getForecastRecordTypeC() != null) {
				preparedStatement.setString(74, forecastHistoryC.getForecastRecordTypeC().getValue());
			} else {
				preparedStatement.setString(74, null);
			}

			if (forecastHistoryC.getASPQ1C() != null) {
				preparedStatement.setString(75, forecastHistoryC.getASPQ1C().getValue());
			} else {
				preparedStatement.setString(75, null);
			}

			if (forecastHistoryC.getASPQ2C() != null) {
				preparedStatement.setString(76, forecastHistoryC.getASPQ2C().getValue());
			} else {
				preparedStatement.setString(76, null);
			}

			if (forecastHistoryC.getASPQ3C() != null) {
				preparedStatement.setString(77, forecastHistoryC.getASPQ3C().getValue());
			} else {
				preparedStatement.setString(77, null);
			}

			if (forecastHistoryC.getASPQ4C() != null) {
				preparedStatement.setString(78, forecastHistoryC.getASPQ4C().getValue());
			} else {
				preparedStatement.setString(78, null);
			}
			if (forecastHistoryC.getQTYQ1C() != null && forecastHistoryC.getQTYQ1C().getValue() != null) {
				preparedStatement.setString(79, forecastHistoryC.getQTYQ1C().getValue().toString());
			} else {
				preparedStatement.setString(79, null);
			}

			if (forecastHistoryC.getQTYQ2C() != null && forecastHistoryC.getQTYQ2C().getValue() != null) {
				preparedStatement.setString(80, forecastHistoryC.getQTYQ2C().getValue().toString());
			} else {
				preparedStatement.setString(80, null);
			}

			if (forecastHistoryC.getQTYQ3C() != null && forecastHistoryC.getQTYQ3C().getValue() != null) {
				preparedStatement.setString(81, forecastHistoryC.getQTYQ3C().getValue().toString());
			} else {
				preparedStatement.setString(81, null);
			}

			if (forecastHistoryC.getQTYQ4C() != null && forecastHistoryC.getQTYQ4C().getValue() != null) {
				preparedStatement.setString(82, forecastHistoryC.getQTYQ4C().getValue().toString());
			} else {
			...
			if (forecastHistoryC.getASPQ11C() != null && forecastHistoryC.getASPQ11C().getValue() != null) {
				preparedStatement.setString(96, forecastHistoryC.getASPQ11C().getValue().toString());
			} else {
				preparedStatement.setString(96, null);
			}

			if (forecastHistoryC.getASPQ22C() != null && forecastHistoryC.getASPQ22C().getValue() != null) {
				preparedStatement.setString(97, forecastHistoryC.getASPQ22C().getValue().toString());
			} else {
				preparedStatement.setString(97, null);
			}

			if (forecastHistoryC.getASPQ33C() != null && forecastHistoryC.getASPQ33C().getValue() != null) {
				preparedStatement.setString(98, forecastHistoryC.getASPQ33C().getValue().toString());
			} else {
				preparedStatement.setString(98, null);
			}

			if (forecastHistoryC.getASPQ44C() != null && forecastHistoryC.getASPQ44C().getValue() != null) {
				preparedStatement.setString(99, forecastHistoryC.getASPQ44C().getValue().toString());
			} else {
				preparedStatement.setString(99, null);
			}

			if (forecastHistoryC.getCostC() != null && forecastHistoryC.getCostC().getValue() != null) {
				preparedStatement.setString(100, forecastHistoryC.getCostC().getValue().toString());
			} else {
			...
			if (forecastHistoryC.getCreationDateC() != null && forecastHistoryC.getCreationDateC().getValue() != null) {
				LOGGER.debug("Get creation date " + forecastHistoryC.getCreationDateC().getValue());
			...
			if (forecastHistoryC.getREVQ1C() != null && forecastHistoryC.getREVQ1C().getValue() != null) {
				preparedStatement.setString(114, forecastHistoryC.getREVQ1C().getValue().getValue().toString());
			} else {
				preparedStatement.setString(114, null);
			}

			if (forecastHistoryC.getREVQ2C() != null && forecastHistoryC.getREVQ2C().getValue() != null) {
				preparedStatement.setString(115, forecastHistoryC.getREVQ2C().getValue().getValue().toString());
			} else {
				preparedStatement.setString(115, null);
			}

			if (forecastHistoryC.getREVQ3C() != null && forecastHistoryC.getREVQ3C().getValue() != null) {
				preparedStatement.setString(116, forecastHistoryC.getREVQ3C().getValue().getValue().toString());
			} else {
				preparedStatement.setString(116, null);
			}

			if (forecastHistoryC.getREVQ4C() != null && forecastHistoryC.getREVQ4C().getValue() != null) {
				preparedStatement.setString(117, forecastHistoryC.getREVQ4C().getValue().getValue().toString());
			} else {
				preparedStatement.setString(117, null);
			}
			preparedStatement.setString(118, "INVN");
		} catch (Exception e) {
			System.out.println("Mapping failed for " + forecastHistoryC.getRecordName());
			e.printStackTrace();
		}
