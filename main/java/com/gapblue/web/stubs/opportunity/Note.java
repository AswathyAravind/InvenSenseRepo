...
public class Note {
    ...
    @XmlElementRef(name = "UpdateFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/notes/noteService", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> updateFlag;
    @XmlElementRef(name = "DeleteFlag", namespace = "http://xmlns.oracle.com/apps/crmCommon/notes/noteService", type = JAXBElement.class, required = false)
